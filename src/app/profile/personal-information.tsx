...
const PersonalInformation = ({ employeeData, onUpdate }: Props) => {
  ...
  useEffect(() => {
    if (employeeData) {
      if (employeeData.gender) setGender(employeeData.gender);
      if (employeeData.education) setEducation(employeeData.education);
      if (employeeData.blood_type) setBloodType(employeeData.blood_type);
      if (employeeData.marital_status)
        setMaritalStatus(employeeData.marital_status);
      if (employeeData.religion) setReligion(employeeData.religion);
    }
  }, [employeeData]);
  ...
  const handleSubmitForm = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/employees/${employeeData?.employee_id}?_method=PATCH`,
        {
          method: "POST",
          headers: {
  ...
  const handleOkClick = async () => {
    if (onUpdate) onUpdate(); // panggil fetchData() di parent
    ...
    <Card className="flex-1 h-full ml-[20px] gap-[15px] rounded-[15px] border border-black/15 bg-white shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] overflow-hidden">
              ...
              <div>
                ...
                >
                  <div className="flex flex-col gap-[15px] mt-[15px]">
                    ...
                    <div className="flex gap-[10px]">
                      <div className="flex flex-col flex-1 gap-[8px]">
                        ...
                        <Input
                          ...
                          defaultValue={employeeData?.birth_place ?? ""}
                        />
                      </div>
                      <div className="flex flex-col flex-1 gap-[8px]">
                    ...
                    <div className="flex gap-[10px]">
                      <div className="flex flex-col flex-1 gap-[8px]">
                        <Label htmlFor="maritial-_status">
                          Maritial Status
                        </Label>
                        <Select
                          value={maritalStatus}
                    ...
                    <div className="flex gap-[10px]">
                      <div className="flex flex-col flex-1 gap-[8px]">
                        ...
                        <Input
                          ...
                          defaultValue={employeeData?.citizenship ?? ""}
                        />
                      </div>
                      <div className="flex flex-col flex-1 gap-[8px]">
      ...
      <div className="flex mx-[20px] gap-[10px]">
        <div className="flex flex-col flex-1 gap-[8px] overflow-hidden">
          ...
          <span className="text-gray-600 border border-neutral-300 rounded-md px-4 py-3">
